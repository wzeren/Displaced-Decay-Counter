...
# Reading Data
print("Loading Input")
data_dict = func.load_data("two",benchmarkscenario ="A")
#######################################################################################
...
func.plot_make_up(ax,fontdict = font,benchmark = "two",mstring ="A")
os.system('if not exist "'+data_dict["plotpath"]+'" mkdir '+data_dict["plotpath"])
savepath = os.path.join(data_dict["plotpath"],"benchmark_twoA.pdf")
