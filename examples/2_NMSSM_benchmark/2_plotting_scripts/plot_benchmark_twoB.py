...
# Reading Data
print("Loading Input")
data_dict = func.load_data("two",benchmarkscenario ="B")
#######################################################################################
...
func.plot_make_up(ax,fontdict = font,benchmark = "two",mstring ="B")
os.system('if not exist "'+data_dict["plotpath"]+'" mkdir '+data_dict["plotpath"])
savepath = os.path.join(data_dict["plotpath"],"benchmark_twoB.pdf")
