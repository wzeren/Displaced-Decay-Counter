 ...
 * The class CylDetLayer defines a detector layer in cylindrical coordinates.
   ...
   It consists of a list (vector) of oriented cylindrical segments, together with a weighing factor, primarily representing the angular aperture around the cylindrical axis (Dphi). An average sensitivity to the decay products could also be included.
*/
